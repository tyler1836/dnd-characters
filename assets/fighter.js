...
levelUp.addEventListener('click', function () {
    ...
    healthC = healthC + Math.floor(Math.random() * 18 + 2);
    strengthC = strengthC + Math.floor(Math.random() * 16 + 1);
    dexterityC = dexterityC + Math.floor(Math.random() * 8 + 1);
    athleticsC = athleticsC + Math.floor(Math.random() * 8 + 1);
    knowledgeC = knowledgeC + Math.floor(Math.random() * 2 + 1);
    wisdomC = wisdomC + Math.floor(Math.random() * 2 + 1);
    strength.innerHTML = strengthC;
    health.innerHTML = healthC;
    level.innerHTML = levelCtr;
    dexterity.innerHTML = dexterityC;
